...
export default function TratosEmpresaGarage() {
  ...
  return <div className="duenio-garage-page"><HeaderDueñoGarage /><main className="duenio-garage-shell">
    ...
    <section className="duenio-section-head left deal-page-heading"><span>Administrador de garage</span><div className="deal-role-chip"><Building2 size={15}/> Empresas → solicitan cocheras → tus garages</div><h1>Tratos con empresas {!loading && (count > 0 ? <span className="deal-pending-count">{count > 99 ? '99+' : count}</span> : null)}</h1><p>Revisá las propuestas que las empresas envían a tus garages y administrá los acuerdos comerciales vigentes.</p></section>
